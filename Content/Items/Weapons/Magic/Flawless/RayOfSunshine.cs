...
namespace Polarities.Content.Items.Weapons.Magic.Flawless
{
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/SunPixie/SunPixieDeathray";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                _ = Projectile.Center;
                _ = Projectile.Center + new Vector2(radius, 0).RotatedBy(Projectile.rotation);
                _ = 12 * Projectile.scale;

                float colorAmount = (numLayers - i) / numLayers;

                Color color = new((int)(255 * colorAmount + 255 * (1 - colorAmount)), (int)(195 * colorAmount + 255 * (1 - colorAmount)), (int)(32 * colorAmount + 255 * (1 - colorAmount)));
