...
namespace Polarities.Content.NPCs.Bosses.PreHardmode.RiftDenizen
{
    [AutoloadBossHead]
    public class RiftDenizen : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/RiftDenizen");
                ...
                case 0:
                    ...
                    if (NPC.localAI[0] >= 30)
                    {
                        for (int i = -2; i <= 2; i++)
                        {
                            ...
                            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Polarities/Content/Projectiles/CallShootProjectile", AssetRequestMode.ImmediateLoad).Value, NPC.Center - screenPos, new Rectangle(0, 0, 1, 1), Color.White * 0.5f * alpha, NPC.rotation + i * MathHelper.Pi / 6, new Vector2(0, 0.5f), new Vector2(telegraphDistance, 2), SpriteEffects.None, 0f);
                        }
                    }
                    break;
            }
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftOpening";
    ...
    public class RiftDenizenSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Polarities/Content/Projectiles/CallShootProjectile", AssetRequestMode.ImmediateLoad).Value, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), new Color(36, 80, 123) * skyAlpha);

                Texture2D skyBeam = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftDenizenSky", AssetRequestMode.ImmediateLoad).Value;
        ...
        private void DrawBoss(SpriteBatch spriteBatch, Vector2 bossPosition)
        {
            ...
            {
                Texture2D rayTexture = ModContent.Request<Texture2D>("Polarities/Content/Projectiles/CallShootProjectile", AssetRequestMode.ImmediateLoad).Value;
                ...
                Texture2D chainTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftClawChain", AssetRequestMode.ImmediateLoad).Value;
                for (int i = 0; i < guidePoints.Length; i++)
                {
                ...
                Texture2D clawTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftDenizenClaw", AssetRequestMode.ImmediateLoad).Value;
                for (int i = 0; i < guidePoints.Length; i++)
                {
                ...
                Texture2D eyeTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftDenizenEye", AssetRequestMode.ImmediateLoad).Value;
        ...
        private void DrawRifts(SpriteBatch spriteBatch)
        {
            ...
            for (int j = 0; j < maxRifts; j++)
            {
                ...
                Texture2D riftTexture = ModContent.Request<Texture2D>("Polarities/Content/Biomes/Fractal/rift_1", AssetRequestMode.ImmediateLoad).Value;
                Vector2 drawPos = new Vector2(rifts[i, 0], rifts[i, 1]) + Main.screenPosition * rifts[i, 2] - Main.screenPosition;
    ...
    public class ParallaxRay : ModProjectile
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/ParallaxRayTelegraph", AssetRequestMode.ImmediateLoad).Value;
            Rectangle frame = texture.Frame();
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/ParallaxRay";
    ...
    public class ParallaxBolt : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.localAI[0] < 60)
            {
                texture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/ParallaxBoltTelegraph", AssetRequestMode.ImmediateLoad).Value;
                frame = texture.Frame();
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/ParallaxBolt";
    ...
    public class RiftBolt : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D texture = ModContent.Request<Texture2D>("Polarities/Content/Projectiles/CallShootProjectile", AssetRequestMode.ImmediateLoad).Value;
    ...
    public class RiftClaw : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.localAI[0] <= 60)
            {
                texture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/ChordRayCap", AssetRequestMode.ImmediateLoad).Value;
                frame = texture.Frame();
            ...
            texture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/PreHardmode/RiftDenizen/RiftClawChain", AssetRequestMode.ImmediateLoad).Value;
            frame = texture.Frame();
