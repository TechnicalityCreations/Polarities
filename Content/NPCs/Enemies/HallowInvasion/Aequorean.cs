...
namespace Polarities.Content.NPCs.Enemies.HallowInvasion
{
    public class Aequorean : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (spawnInfo.Player.InModBiome(GetInstance<Content.Events.HallowInvasion>()))
            {
                return Content.Events.HallowInvasion.GetSpawnChance(3);
            }
            return 0f;
        }
    }
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Enemies/HallowInvasion/Aequorean_Glow";
